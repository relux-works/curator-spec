...
func managerConfigV2SchemaExamples(valid map[string]any) []schemaExample {
	...
	return []schemaExample{
		...
		{name: "valid-overlay-path-file-url", valid: true, instance: withOverlay(map[string]any{"source": "file:///Users/operator/context"})},
		...
		{name: "invalid-overlay-path-file-requirement-form", instance: withOverlay(map[string]any{"source": "file:///Users/operator/context", "revision": strings.Repeat("ab", 20)})},
...
func managerConfigV2Vectors() []any {
	...
	return []any{
		...
		map[string]any{
			"name": "schema2-overlay-path-file-url", "input": withEnvironments(map[string]any{"overlays": map[string]any{"companyA": []any{map[string]any{"source": "file:///Users/operator/context"}}}}), "valid": true,
			"expected": map[string]any{"environments": expectedWith(map[string]any{"overlays": map[string]any{"companyA": []any{map[string]any{"source": "file:///Users/operator/context"}}}})},
		},
		map[string]any{
		...
		map[string]any{"name": "schema2-overlay-path-file-requirement-form", "input": withEnvironments(map[string]any{"overlays": map[string]any{"companyA": []any{map[string]any{"source": "file:///Users/operator/context", "revision": strings.Repeat("ab", 20)}}}}), "valid": false},
