...
func writeBehaviorVectors(dir, snapshotHash string) {
	...
	writeJSON(filepath.Join(dir, "registry-behavior.json"), map[string]any{
		...
		"bootstrap":     map[string]any{"checkpoint_object": "registry-snapshot-v1", "checkpoint_form": "path", "verified_before_network": true, "tofu_posture": "registry_bootstrap_tofu", "regression_diagnostic": "registry_checkpoint_regression", "first_fixation_source": "checkpoint-or-network-only"},
		"divergence":    map[string]any{"compared_at": "same_log_size", "diagnostic": "registry_view_divergence", "resolution_changed": false, "quorum": false},
...
func writeRegistryClientVectors(dir string) {
	writeJSON(filepath.Join(dir, "registry-client.json"), map[string]any{
		...
		// bootstrap_cases follows registry protocol section 5 and section
		// 5.1. The `phase` selects the arm: `bootstrap` (first use, prior
		// state missing) verifies a configured checkpoint signature first
		// and persists it before any network response is accepted, so a
		// tampered first network leaves state_changed true; without a
		// checkpoint the first view fixes the high-water with the
		// `registry_bootstrap_tofu` posture. `rebootstrap` (prior state
		// present) refuses a checkpoint below the high-water, or equal
		// with a different body, with `registry_checkpoint_regression`
		// and leaves state unchanged; the registry itself is not
		// excluded. `compare` states the behavior of a client that
		// implements section 5.1 detection: two or more enabled
		// registries of one mirror group exposing the same log size are
		// compared by Merkle root, a difference reports
		// `registry_view_divergence` (warning under advisory, error
		// under strict), and resolution never changes. `candidate_same_body`
		// is the first network body against the checkpoint on the
		// bootstrap arm and the checkpoint body against the stored body
		// on the rebootstrap arm; other arms carry placeholders, as do
		// the group inputs off the compare arm. Both bad-signature cases
		// keep consistent versions to prove verification precedes
		// comparison, and carry no diagnostic: a bad checkpoint is a
		// configuration error naming the path, failing closed.
		// `check_current` is the manager profile section 10 `--check`
		// outcome per row: false for a refused checkpoint, a strict
		// divergence, and a first-use configuration error, true for
		// every other row including TOFU and advisory warnings.
		"bootstrap_cases": []any{
			map[string]any{"name": "checkpoint-first-use-accepted", "phase": "bootstrap", "checkpoint_configured": true, "signature_valid": true, "prior_state": "missing", "checkpoint_version": 8, "stored_version": 0, "first_network_version": 9, "candidate_same_body": false, "group_size": 0, "same_log_size": false, "roots_equal": true, "policy": "advisory", "accepted": true, "state_changed": true, "diagnostic": nil, "posture": nil, "severity": nil, "compared": false, "registry_excluded": false, "resolution_changed": false, "check_current": true},
			map[string]any{"name": "checkpoint-first-network-below-tampered", "phase": "bootstrap", "checkpoint_configured": true, "signature_valid": true, "prior_state": "missing", "checkpoint_version": 8, "stored_version": 0, "first_network_version": 7, "candidate_same_body": false, "group_size": 0, "same_log_size": false, "roots_equal": true, "policy": "advisory", "accepted": false, "state_changed": true, "diagnostic": nil, "posture": nil, "severity": nil, "compared": false, "registry_excluded": true, "resolution_changed": false, "check_current": true},
			map[string]any{"name": "checkpoint-first-network-equal-different-tampered", "phase": "bootstrap", "checkpoint_configured": true, "signature_valid": true, "prior_state": "missing", "checkpoint_version": 8, "stored_version": 0, "first_network_version": 8, "candidate_same_body": false, "group_size": 0, "same_log_size": false, "roots_equal": true, "policy": "advisory", "accepted": false, "state_changed": true, "diagnostic": nil, "posture": nil, "severity": nil, "compared": false, "registry_excluded": true, "resolution_changed": false, "check_current": true},
			map[string]any{"name": "no-checkpoint-first-use-tofu", "phase": "bootstrap", "checkpoint_configured": false, "signature_valid": true, "prior_state": "missing", "checkpoint_version": 0, "stored_version": 0, "first_network_version": 5, "candidate_same_body": false, "group_size": 0, "same_log_size": false, "roots_equal": true, "policy": "advisory", "accepted": true, "state_changed": true, "diagnostic": nil, "posture": "registry_bootstrap_tofu", "severity": "warning", "compared": false, "registry_excluded": false, "resolution_changed": false, "check_current": true},
			map[string]any{"name": "checkpoint-signature-invalid-first-use", "phase": "bootstrap", "checkpoint_configured": true, "signature_valid": false, "prior_state": "missing", "checkpoint_version": 8, "stored_version": 0, "first_network_version": 8, "candidate_same_body": true, "group_size": 0, "same_log_size": false, "roots_equal": true, "policy": "advisory", "accepted": false, "state_changed": false, "diagnostic": nil, "posture": nil, "severity": nil, "compared": false, "registry_excluded": true, "resolution_changed": false, "check_current": false},
			map[string]any{"name": "rebootstrap-advance-accepted", "phase": "rebootstrap", "checkpoint_configured": true, "signature_valid": true, "prior_state": "present", "checkpoint_version": 10, "stored_version": 8, "first_network_version": 0, "candidate_same_body": false, "group_size": 0, "same_log_size": false, "roots_equal": true, "policy": "advisory", "accepted": true, "state_changed": true, "diagnostic": nil, "posture": nil, "severity": nil, "compared": false, "registry_excluded": false, "resolution_changed": false, "check_current": true},
			map[string]any{"name": "rebootstrap-equal-consistent-noop", "phase": "rebootstrap", "checkpoint_configured": true, "signature_valid": true, "prior_state": "present", "checkpoint_version": 8, "stored_version": 8, "first_network_version": 0, "candidate_same_body": true, "group_size": 0, "same_log_size": false, "roots_equal": true, "policy": "advisory", "accepted": true, "state_changed": false, "diagnostic": nil, "posture": nil, "severity": nil, "compared": false, "registry_excluded": false, "resolution_changed": false, "check_current": true},
			map[string]any{"name": "rebootstrap-regression-refused", "phase": "rebootstrap", "checkpoint_configured": true, "signature_valid": true, "prior_state": "present", "checkpoint_version": 7, "stored_version": 8, "first_network_version": 0, "candidate_same_body": false, "group_size": 0, "same_log_size": false, "roots_equal": true, "policy": "advisory", "accepted": false, "state_changed": false, "diagnostic": "registry_checkpoint_regression", "posture": nil, "severity": "error", "compared": false, "registry_excluded": false, "resolution_changed": false, "check_current": false},
			map[string]any{"name": "rebootstrap-equal-inconsistent-refused", "phase": "rebootstrap", "checkpoint_configured": true, "signature_valid": true, "prior_state": "present", "checkpoint_version": 8, "stored_version": 8, "first_network_version": 0, "candidate_same_body": false, "group_size": 0, "same_log_size": false, "roots_equal": true, "policy": "advisory", "accepted": false, "state_changed": false, "diagnostic": "registry_checkpoint_regression", "posture": nil, "severity": "error", "compared": false, "registry_excluded": false, "resolution_changed": false, "check_current": false},
			map[string]any{"name": "rebootstrap-signature-invalid-ignored", "phase": "rebootstrap", "checkpoint_configured": true, "signature_valid": false, "prior_state": "present", "checkpoint_version": 10, "stored_version": 8, "first_network_version": 0, "candidate_same_body": false, "group_size": 0, "same_log_size": false, "roots_equal": true, "policy": "advisory", "accepted": false, "state_changed": false, "diagnostic": nil, "posture": nil, "severity": nil, "compared": false, "registry_excluded": false, "resolution_changed": false, "check_current": true},
			map[string]any{"name": "divergence-detected-advisory", "phase": "compare", "checkpoint_configured": false, "signature_valid": true, "prior_state": "present", "checkpoint_version": 0, "stored_version": 8, "first_network_version": 0, "candidate_same_body": true, "group_size": 2, "same_log_size": true, "roots_equal": false, "policy": "advisory", "accepted": true, "state_changed": false, "diagnostic": "registry_view_divergence", "posture": nil, "severity": "warning", "compared": true, "registry_excluded": false, "resolution_changed": false, "check_current": true},
			map[string]any{"name": "divergence-detected-strict", "phase": "compare", "checkpoint_configured": false, "signature_valid": true, "prior_state": "present", "checkpoint_version": 0, "stored_version": 8, "first_network_version": 0, "candidate_same_body": true, "group_size": 2, "same_log_size": true, "roots_equal": false, "policy": "strict", "accepted": true, "state_changed": false, "diagnostic": "registry_view_divergence", "posture": nil, "severity": "error", "compared": true, "registry_excluded": false, "resolution_changed": false, "check_current": false},
			map[string]any{"name": "divergence-views-agree", "phase": "compare", "checkpoint_configured": false, "signature_valid": true, "prior_state": "present", "checkpoint_version": 0, "stored_version": 8, "first_network_version": 0, "candidate_same_body": true, "group_size": 2, "same_log_size": true, "roots_equal": true, "policy": "advisory", "accepted": true, "state_changed": false, "diagnostic": nil, "posture": nil, "severity": nil, "compared": true, "registry_excluded": false, "resolution_changed": false, "check_current": true},
			map[string]any{"name": "divergence-different-sizes-skipped", "phase": "compare", "checkpoint_configured": false, "signature_valid": true, "prior_state": "present", "checkpoint_version": 0, "stored_version": 8, "first_network_version": 0, "candidate_same_body": true, "group_size": 2, "same_log_size": false, "roots_equal": false, "policy": "advisory", "accepted": true, "state_changed": false, "diagnostic": nil, "posture": nil, "severity": nil, "compared": false, "registry_excluded": false, "resolution_changed": false, "check_current": true},
			map[string]any{"name": "divergence-single-registry-skipped", "phase": "compare", "checkpoint_configured": false, "signature_valid": true, "prior_state": "present", "checkpoint_version": 0, "stored_version": 8, "first_network_version": 0, "candidate_same_body": true, "group_size": 1, "same_log_size": true, "roots_equal": false, "policy": "advisory", "accepted": true, "state_changed": false, "diagnostic": nil, "posture": nil, "severity": nil, "compared": false, "registry_excluded": false, "resolution_changed": false, "check_current": true},
		},
	})
}
...
func writeSchemaCases(suite string, marker, ledger, audited, snapshot, logEntry, bundle map[string]any, pinned string) {
	validSkill := func(version int) map[string]any {
		...
		if version >= 8 {
			obj["commands"].(map[string]any)["build-tool"].(map[string]any)["modules"] = []any{
	...
	for version := 1; version <= 8; version++ {
		...
		for _, prefix := range []string{"agent-skill", "csk-skill"} {
			...
			case version == 8:
				...
				additionalCases[name] = append(additionalCases[name], moduleRootSchemaExamples()...)
			default:
...
func validModuleRootSkillManifest() map[string]any {
	return map[string]any{
		"schema_version": 8,
		"capabilities":   map[string]any{},
		"build_roots":    []any{"tools/cli"},
		"commands": map[string]any{
			"tool": map[string]any{
				"type": "build", "driver": "go-v1", "source_dir": "tools/cli/cmd/tool",
				"modules": []any{"pkg/board", "pkg/remoteconfig"},
			},
		},
	}
}

// moduleRootSchemaExamples covers the structural portion of the schema-8
// module-root declaration. Filesystem, graph, and platform-path comparisons
// remain semantic conformance rules rather than JSON Schema rules.
func moduleRootSchemaExamples() []schemaExample {
	withModules := func(value any) map[string]any {
		manifest := validModuleRootSkillManifest()
		manifest["commands"].(map[string]any)["tool"].(map[string]any)["modules"] = value
		return manifest
	}
	...
	empty := withModules([]any{})
	absent := validModuleRootSkillManifest()
	delete(absent["commands"].(map[string]any)["tool"].(map[string]any), "modules")

	return []schemaExample{
		{name: "valid-module-roots-declared", valid: true, instance: validModuleRootSkillManifest()},
		{name: "valid-module-roots-empty", valid: true, instance: empty},
		{name: "valid-module-roots-absent", valid: true, instance: absent},
		{name: "invalid-module-roots-duplicate", instance: withModules([]any{"pkg/lib", "pkg/lib"})},
		{name: "invalid-module-roots-dot", instance: withModules([]any{"."})},
		{name: "invalid-module-roots-parent", instance: withModules([]any{"../pkg/lib"})},
		{name: "invalid-module-roots-absolute", instance: withModules([]any{"/pkg/lib"})},
		{name: "invalid-module-roots-backslash", instance: withModules([]any{"pkg\\lib"})},
		{name: "invalid-module-roots-windows-device", instance: withModules([]any{"pkg/CON"})},
		{name: "invalid-module-roots-string", instance: withModules("pkg/lib")},
		{name: "invalid-module-roots-null", instance: withModules(nil)},
		{name: "invalid-module-roots-on-script-command", instance: withCommand("script", map[string]any{
			"type": "script", "unix_path": "scripts/tool", "modules": []any{"pkg/lib"},
		})},
		{name: "invalid-module-roots-on-system-command", instance: withCommand("system", map[string]any{
			"type": "system", "command": "tool", "modules": []any{"pkg/lib"},
		})},
		{name: "invalid-module-roots-on-repository-command", instance: withCommand("repository", map[string]any{
			"type": "build", "driver": "go-repository-v1", "repository": "golden-tools", "target": "tool",
			"modules": []any{"pkg/lib"},
		})},
		{name: "invalid-module-roots-top-level", instance: withNestedField(
			validModuleRootSkillManifest(), []string{}, "modules", []any{"pkg/lib"})},
	}
}
