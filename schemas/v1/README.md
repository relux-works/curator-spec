...
- `curator-build-v1.schema.json` for repository-root logical targets;
...
and mixed-marker top-level `build_source` presence, are enforced by
`tools/validate.py` and covered by deterministic generated cases.
