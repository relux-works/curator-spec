...
- Manifest schemas 1 through 6, `go-v1`, receipt v1, markers v1/v2, claim
  v1/v2, and rc.4 generated bytes retain their prior meaning and frozen guards.
...
- Source hooks, helpers, filters, submodules, LFS hydration, alternates,
  replacements, grafts, promisor/lazy fetch, package PATH/output control, and
  install-time signing remain outside the closed driver.
