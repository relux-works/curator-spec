...
- Manifest schema 7, repository-root descriptor schema 1, development
  substitution schema 2, build receipt schema 2, install marker schema 3, and
  conformance claim schema 3 for the closed `go-repository-v1` driver.
